...
export async function middleware(req: NextRequest) {
  ...
  if (!isAuth) {
    // 🔥 ÇÖZÜM BURADA: req.url yerine nextUrl.clone() kullanıyoruz.
    // Bu sayede Railway proxy'sine takılmadan admin.sekerco.com adresini koruyoruz.
    ...
    // Yönlendirme sonrası doğru yere dönebilmesi için

  ...
  return (
    <div>
      ...
      <div className="sf-card" style={{ marginTop: 16, textAlign: 'center', padding: 40 }}>
        ...
        <div className="sf-muted" style={{ fontSize: 13, marginTop: 6 }}>Faz 3'te Customer Account API ile adres CRUD.</div>
        <button className="sf-btn" style={{ marginTop: 14 }}>➕ Adres Ekle</button>
      </div>
    </div>
  )
}
